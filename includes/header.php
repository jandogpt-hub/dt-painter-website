    ...
    <nav class="fixed top-0 w-full z-50 glass-morphism border-b border-white/5 py-3 lg:py-4 transition-all duration-300" id="main-nav">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center h-16">
            ...
            <div class="lg:hidden flex-1 flex justify-center">
                 <a href="tel:<?php echo defined('SITE_PHONE') ? preg_replace('/[^0-9]/', '', SITE_PHONE) : '5551234567'; ?>" class="flex items-center gap-2 bg-brand-red px-4 py-2 rounded-full shadow-lg hover:bg-red-600 transition-colors">
                    <svg class="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span class="text-xs font-bold text-white tracking-widest uppercase">Call Us</span>
                 </a>
            </div>
        ...
        <div id="mobile-menu" class="fixed top-0 left-0 w-full h-screen bg-brand-dark/95 backdrop-blur-xl z-[60] hidden flex-col pt-24 px-6 gap-6 overflow-y-auto transition-opacity duration-300">
             ...
             <div class="mt-8 space-y-4">
                 ...
                 <a href="#quote" class="block w-full text-center py-4 border border-white/20 hover:bg-white/5 rounded-sm text-white font-bold uppercase tracking-widest">Get a Free Virtual Quote</a>
             </div>
        </div>
